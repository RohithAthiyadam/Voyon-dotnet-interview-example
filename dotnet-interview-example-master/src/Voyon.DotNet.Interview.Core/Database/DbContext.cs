...
namespace Voyon.DotNet.Interview.Core.Database
{
    ...
    {
        private const string DATABASE_PATH = @"E:\Rohith\Voyon\dotnet-interview-example-master\src\Voyon.DotNet.Interview.Web\database.json";
        ...
        private Database InitializeDatabase()
        {
            ...
            database.Tasks.Add(new Task
            {
                ...
                Description = "Voyon.DotNet.Interview.Logic.BL.TaskLogic has some flaws and needs a refactor.<br />" +
